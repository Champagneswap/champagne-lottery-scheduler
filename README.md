...
- `Lottery` Address of [ChampagneSwapLottery](https://github.com/Champagne/champagne-contracts/tree/master/projects/lottery) contract.
...
```shell script
# Close lottery.
0 0,12 * * * cd ~/champagne-lottery-scheduler && yarn execute:close:mainnet

# Draw lottery.
3 0,12 * * * cd ~/champagne-lottery-scheduler && yarn execute:draw:mainnet

# Start lottery.
5 0,12 * * * cd ~/champagne-lottery-scheduler && yarn execute:start:mainnet
```
